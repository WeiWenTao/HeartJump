...
public class CustomTimePicker extends TimePicker
{
    ...
    public CustomTimePicker(Context context, AttributeSet attrs)
    {
        ...
        //设置分割线颜色
        CommonUtils.setNumberPickerDivider(mContext,hourNumberPicker);
        CommonUtils.setNumberPickerDivider(mContext,minuteNumberPicker);
        CommonUtils.setNumberPickerDivider(mContext,amPmNumberPicker);
    }
}
