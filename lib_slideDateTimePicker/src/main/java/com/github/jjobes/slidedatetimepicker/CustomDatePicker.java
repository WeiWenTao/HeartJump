...
public class CustomDatePicker extends DatePicker
{
    ...
    public CustomDatePicker(Context context, AttributeSet attrs)
    {
        ...
        //设置分割线颜色
        CommonUtils.setNumberPickerDivider(mContext,dayNumberPicker);
        CommonUtils.setNumberPickerDivider(mContext,monthNumberPicker);
        CommonUtils.setNumberPickerDivider(mContext,yearNumberPicker);
    }
}
