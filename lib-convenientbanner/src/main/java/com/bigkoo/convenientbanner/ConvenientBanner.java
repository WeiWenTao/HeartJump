 ...
 * @author Sai 支持自动翻页
 */
public class ConvenientBanner<T> extends LinearLayout implements View.OnClickListener {
    ...
    public void onClick(View v) {
        setcurrentitem(loPageTurningPoint.indexOfChild(v));
    }
