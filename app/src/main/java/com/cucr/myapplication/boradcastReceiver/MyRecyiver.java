...
public class MyRecyiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        Log.d("JPush——onReceive", "onReceive - " + intent.getAction());
        ...
        if (JPushInterface.ACTION_REGISTRATION_ID.equals(intent.getAction())) {
            ...
            System.out.println("JPush——收到了自定义消息@@消息内容是:" + content);
            System.out.println("JPush——收到了自定义消息@@消息extra是:" + extra);
...
//            MyApp.data.add(map);
            //**************解析推送过来的json数据并存放到集合中 end******************
                ...
                .getAction())) {
            System.out.println("JPush——收到了通知");
            // 在这里可以做些统计，或者做些其他工作
            ...
            System.out.println("JPush——content" + content);
            System.out.println("JPush——extra" + extra);
