...
public class CreatFtActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_creat_ft);
    ...
    private void initHeadBar() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            ...
            LinearLayout.LayoutParams layoutParams = (LinearLayout.LayoutParams) rl_head_bar.getLayoutParams();
            layoutParams.height = CommonUtils.dip2px(this, 73.0f);
            rl_head_bar.setLayoutParams(layoutParams);
            rl_head_bar.requestLayout();
        }
