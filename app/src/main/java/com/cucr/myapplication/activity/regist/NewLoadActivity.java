...
public class NewLoadActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mIntent = new Intent(this,NewRegistActivity.class);
    ...
    private void initViews() {
        ...
        mEt_accunt.setText(((String) SpUtil.getParam(this, SpConstant.USER_NAEM, "")));
        mEt_psw.setText(((String) SpUtil.getParam(this, SpConstant.PASSWORD, "")));
    }
    ...
    public void load(View view){
        ...
        //TODO 输入判断
        mLoginCore.login(this, mEt_accunt.getText().toString(), mEt_psw.getText().toString(), new OnLoginListener() {
            @Override
...
//                    保存密钥
                    SpUtil.setParam(NewLoadActivity.this, SpConstant.SIGN, loadSuccess.getSign());
//                    保存用户id
                    SpUtil.setParam(NewLoadActivity.this, SpConstant.USER_ID, loadSuccess.getUserId());
//                    保存认证信息
                    SpUtil.getParam(NewLoadActivity.this, SpConstant.ROLEID, loadSuccess.getRoleId());
//                    存储账号和密码等信息
                    SpUtil.setParam(NewLoadActivity.this, SpConstant.USER_NAEM, mEt_accunt.getText().toString());
                    SpUtil.setParam(NewLoadActivity.this, SpConstant.PASSWORD, mEt_psw.getText().toString());

                    MyLogger.jLog().i("PSWuseid:" + loadSuccess.getUserId());
//                    显示吐司
                    ToastUtils.showToast("登录成功");

                    JPushInterface.setTags(NewLoadActivity.this, tags, new TagAliasCallback() {
                        @Override
...
//                    跳转到主界面
                    startActivity(new Intent(NewLoadActivity.this, MainActivity.class));
                    finish();
