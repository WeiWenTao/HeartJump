...
public class FtListAdapter extends BaseAdapter implements View.OnClickListener {
    Context mContext;
    ...
    public View getView(int position, View convertView, final ViewGroup parent) {
        ...
        switch (type){
            case Constans.TYPE_ONE:
                cvh1 = CommonViewHolder.createCVH(convertView, parent.getContext(), R.layout.item_ft_list_type1,null);
            ...
            case Constans.TYPE_TWO:
                cvh2 = CommonViewHolder.createCVH(convertView, parent.getContext(), R.layout.item_ft_list_type2,null);
