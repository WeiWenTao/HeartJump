        ...
        int type = getItemViewType(position % 2);
            switch (type){
                ...
                case Constans.TYPE_ONE:
                    cvh1 = CommonViewHolder.createCVH(convertView, parent.getContext(), R.layout.item_journey_catgory_type1,null);
                ...
                case Constans.TYPE_TWO:
                    cvh2 = CommonViewHolder.createCVH(convertView, parent.getContext(), R.layout.item_journey_catgory_type2,null);
