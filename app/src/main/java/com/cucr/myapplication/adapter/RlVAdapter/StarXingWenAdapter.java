 ...
 */
public class StarXingWenAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            ...
            case Constans.TYPE_VIDEO:
                return new Tp1_Holder(mLayoutInflater.inflate(R.layout.item_xw_type02_star, parent, false));

            //图片(+文字)
            case Constans.TYPE_PICTURE:
                return new Tp2_Holder(mLayoutInflater.inflate(R.layout.item_xw_type01_star, parent, false));

            //纯文本
            case Constans.TYPE_TEXT:
                return new Tp3_Holder(mLayoutInflater.inflate(R.layout.item_xw_type00_star, parent, false));

            //图集
            case Constans.TYPE_ALBUM:
                return new Tp4_Holder(mLayoutInflater.inflate(R.layout.item_xw_type03_star, parent, false));

            //头部
            case Constans.TYPE_NEWS_HEAD:
                return new Tp5_Holder(mLayoutInflater.inflate(R.layout.item_xw_head, parent, false));
    ...
    public int getItemViewType(int position) {
        if (position == 0) {
            return Constans.TYPE_NEWS_HEAD;
        } else {
...
// -------------------------------------------------------------------------------------------------
    ...
    class Tp5_Holder extends RecyclerView.ViewHolder {
        public Tp5_Holder(View itemView) {
            super(itemView);
        }
    }
