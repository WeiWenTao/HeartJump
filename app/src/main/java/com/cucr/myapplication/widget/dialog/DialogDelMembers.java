...
public class DialogDelMembers extends Dialog implements View.OnClickListener {

    public DialogDelMembers(Context context, int themeResId) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_del_members);
