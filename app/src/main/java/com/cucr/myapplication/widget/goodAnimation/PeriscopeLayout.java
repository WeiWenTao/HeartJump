...
package com.cucr.myapplication.widget.goodAnimation;
...
public class PeriscopeLayout extends RelativeLayout {
    ...
    private void init() {
        ...
        Drawable yellow = getResources().getDrawable(R.drawable.love);
        Drawable blue = getResources().getDrawable(R.drawable.love);
    ...
    private ValueAnimator getBezierValueAnimator(View target) {
        ...
        ValueAnimator animator = ValueAnimator.ofObject(evaluator, new PointF((mWidth - dWidth- marginRight) , mHeight - dHeight - marginBottom), new PointF(random.nextInt(getWidth()), 0));
