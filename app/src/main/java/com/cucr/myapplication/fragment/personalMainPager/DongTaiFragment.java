...
import com.cucr.myapplication.adapter.LvAdapter.DongTaiAdapter;
...
public class DongTaiFragment extends Fragment {
    ...
    private void initView(View mView) {
        ListView lv_dongtai_list = (ListView) mView.findViewById(R.id.lv_dongtai_list);
        lv_dongtai_list.setAdapter(new DongTaiAdapter());
    }
}
